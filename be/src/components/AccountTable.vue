<template>
  <div class="container-fluid">
    ...
    <p class="mb-4">
      Bao gồm các thông tin về tài khoản của nhân viên và các thao tác (thêm, sửa, xóa) với từng tài
      khoản
    </p>
    ...
    <div class="card shadow mb-4">
      <div class="card-header py-3">
        <div class="d-sm-flex align-items-center justify-content-between mb-4">
          ...
          >
            <i class="fas fa-user-plus fa-sm text-white-50"></i> Tạo tài khoản nhân viên
          </button>
        </div>
      </div>
      <div class="card-body">
