      ...
      <div id="content-wrapper" class="d-flex flex-column">
        <div id="content">
          ...
          <div class="container-fluid">
            ...
            <p class="mb-4">
              Soát vé đầu vào trong trường hợp xe vào bãi sử dụng vé tháng
            </p>
                  ...
                  >
                    <div class="row">
                      <div class="col-sm-12 col-md-6">
                        <div
                          class="dataTables_filter text-left"
                          id="dataTable_month"
                        >
                          <label>
                            <select
